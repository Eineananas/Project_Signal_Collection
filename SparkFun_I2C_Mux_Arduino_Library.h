...
{
public:
  bool begin(uint8_t deviceAddress = QWIIC_MUX_DEFAULT_ADDRESS, SlowSoftWire &wirePort = wire2); //Check communication and initialize device
...
private:
  SlowSoftWire *_i2cPort;                                  //This stores the user's requested i2c port
